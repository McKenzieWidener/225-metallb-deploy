pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/McKenzieWidener/225-metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('widenemg-225')   // <---- Change this to match your kubernetes cluster credentials
    }
